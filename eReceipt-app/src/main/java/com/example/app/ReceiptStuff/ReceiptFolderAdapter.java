...
//        return new ReceiptFolderAdapter.ReceiptFolderAdapterVh(LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_receipt_folder_recycler_view,null));
//    }
//
//    @Override
...
//    }
//
//    public class ReceiptFolderAdapterVh {
//        TextView nameText;
